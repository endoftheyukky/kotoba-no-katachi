// Minimal CDP driver: node cdp.mjs <base-url> <out-dir>
// Opens headless Chrome, and for each scene sets the viewport, loads a page,
// runs a script in it, and saves a screenshot. Also returns console errors.
